...
import 'package:totto/features/chat/group_history_page.dart';
    ...
    return Container(
      ...
      child: SafeArea(
        child: Row(
          ...
          children: [
            _buildCustomNavItem(
              iconAsset: 'assets/logos/Home.png',
              label: l10n.navHome,
              index: 0,
            ),
            _buildCustomNavItem(
              iconAsset: 'assets/logos/mark_email_unread.png',
              label: l10n.navChat,
              index: 1,
            ),
            _buildCustomNavItem(
              iconAsset: 'assets/logos/Order.png',
              label: l10n.navOrder,
              index: 2,
            ),
            _buildCustomNavItem(
              iconAsset: 'assets/logos/add_business.png',
              label: l10n.navMarketplace,
              index: 3,
            ),
            _buildCustomNavItem(
              iconAsset: 'assets/logos/Profile.png',
          ...
          child: Stack(
            ...
            children: [
              ...
              Image.asset(
                ...
                height: 180,
                errorBuilder: (c, e, s) =>
                    Icon(Icons.image, size: 50, color: Colors.red.shade200),
              ),
            ],
          ),
        ),
        const SizedBox(height: 8),
        PrimaryButton(text: title, onPressed: onPressed, borderRadius: 8.0),
      ],
    );
  }
              ...
              InkWell(
                  onTap: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (context) => const GroupHistoryPage(),
                          ),
                      );
                  },
