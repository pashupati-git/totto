...
class ProductRepository
{
  ...
  /// Fetch all products owned by the current user
  /// Optional [status] parameter can filter by product status (e.g., 'D' for draft, 'P' for published)
  ...
  /// Backend endpoint: DELETE /api/v1/my-product/{productId}/
  ...
  Future<void> deleteMyProduct(String productId) async
  {
    ...
    try
    {
      ...
      // Check if deletion was successful (204 No Content is the standard for successful DELETE)
    ...
    on DioException catch (e)
    {
      ...
      {
        throw Exception('Product not found or you do not have permission to delete it.');
      }
  ...
  /// Changes the product status to 'P' (Published)
  /// [productId] - The unique identifier of the product to publish
  /// Backend endpoint: PATCH /api/v1/my-product/{productId}/
  ...
  /// Only returns products with status 'P' (Published)
  /// Returns a list of Product objects available in the marketplace
